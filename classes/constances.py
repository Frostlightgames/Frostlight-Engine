...
JOYSTICK_RIGHT_STICK_DOWN = [24,JOYSTICK]
JOYSTICK_RIGHT_STICK_RIGHT = [25,JOYSTICK]
JOYSTICK_RIGHT_STICK_UP = [26,JOYSTICK]
JOYSTICK_RIGHT_STICK_LEFT = [27,JOYSTICK]
JOYSTICK_LEFT_STICK_DOWN = [28,JOYSTICK]
JOYSTICK_LEFT_STICK_RIGHT = [29,JOYSTICK]
JOYSTICK_LEFT_STICK_UP = [30,JOYSTICK]
JOYSTICK_LEFT_STICK_LEFT = [31,JOYSTICK]
JOYSTICK_BUTTON_SPECIAL_1_CLICKED = [32,JOYSTICK]
JOYSTICK_BUTTON_SPECIAL_1_PRESSED = [33,JOYSTICK]
JOYSTICK_BUTTON_SPECIAL_1_RELEASED = [34,JOYSTICK]
JOYSTICK_BUTTON_SPECIAL_2_CLICKED = [35,JOYSTICK]
JOYSTICK_BUTTON_SPECIAL_2_PRESSED = [36,JOYSTICK]
JOYSTICK_BUTTON_SPECIAL_2_RELEASED = [37,JOYSTICK]
JOYSTICK_TRIGGER_R1 = [38,JOYSTICK]
JOYSTICK_TRIGGER_L1 = [35,JOYSTICK]
JOYSTICK_TRIGGER_R2 = [36,JOYSTICK]
JOYSTICK_TRIGGER_L2 = [37,JOYSTICK]
